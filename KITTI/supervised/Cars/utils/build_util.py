...
def build_dataset(config,
    ...
    if set_source == 'train' and not evaluate:
        train_dataset = PatchwiseDataset(
            root_dir=config.data_root + config.train_root,
            meta_file=config.data_root + config.train_root + '/',
            link_file=config.pre_data_root + config.train_link,
            det_file=config.pre_data_root + config.train_det,
        ...
        val_dataset = TestSequenceDataset(
            root_dir=config.data_root + config.val_root,
            meta_file=config.data_root + config.val_root + '/',
            link_file=config.pre_data_root + config.val_link,
            det_file=config.pre_data_root + config.val_det,
            det_type=config.det_type,
            tracker_type=config.tracker_type,
            use_frustum=config.use_frustum,
            without_reflectivity=config.without_reflectivity,
        ...
        test_dataset = TestSequenceDataset(
            root_dir=config.data_root + config.test_root,
            meta_file=config.data_root + config.test_root + '/',
            link_file=config.pre_data_root + config.test_link,
            det_file=config.pre_data_root + config.test_det,
            det_type=config.det_type,
            tracker_type=config.tracker_type,
            use_frustum=config.use_frustum,
            without_reflectivity=config.without_reflectivity,
