...
parser = argparse.ArgumentParser(description='PyTorch PC-DAN Evaluation')
...
def main():
    ...
    #train_dataset=torch.load('new_datasets_pt_files/eval_train_dataset_2D.pt')
    #val_dataset=torch.load('new_datasets_pt_files/eval_val_dataset_2D.pt')
