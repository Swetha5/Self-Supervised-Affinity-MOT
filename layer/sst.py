...
class SST(nn.Module):
    ...
    def forward(self, x_pre, x_next, l_pre, l_next, valid_pre=None, valid_next=None):
        ...
        # x_pre and x_net are features for objects, returning them as well
        # shape torch.Size([2, 80, 520])
        feat_pre = x_pre.clone()
        feat_next = x_next.clone()
