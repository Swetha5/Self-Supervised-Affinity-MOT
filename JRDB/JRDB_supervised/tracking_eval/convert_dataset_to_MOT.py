...
def parse_arguments():
    ...
    parser.add_argument('--test', default='test_dataset', help='Directory of testing dataset')
    parser.add_argument('--train', default='train_dataset', help='Directory of training dataset')
    parser.add_argument('-o', '--outdir', default='MOT', help='Directory of MOT output')
