...
parser.add_argument('--result-path', default="ablation/without_random_drop/only_translation/test_epoch_3", type=str)
...
def main():
	...
	#load_model_dir='ablation/without_random_drop/only_translation/ss_JRDB_epoch_3.0_Loss_ 0.0830.pth'
