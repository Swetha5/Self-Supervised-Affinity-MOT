...
class TrackingModule(object):
    ...
    def predict(self, det_imgs, det_info, dets, det_split):
        ...
        #if link_score.shape[0]>80:
            #print('link_score ',link_score.shape[0])
        ...
        #print('det_split_0 ', det_split[0].item())
        #print('det_split_1 ', det_split[1].item())
        '''
        ...
        #end_score=-1*torch.ones(81,device='cuda')
        #end_score = torch.cat((end_score, end_score, end_score), 0).view(3,81)
        #print('end_score ',end_score.shape)

        #new_score=-1*torch.ones(81,device='cuda')
        #new_score = torch.cat((new_score, new_score, new_score), 0).view(3,81)
