...
configure_names = ['init_test_mot17', 'init_train_mot17', 'init_eval_train_mot17',
...
def init_test_mot17():
    ...
    config['mot_root'] = '/home/c3-0/swetha/Datasets/MOT17'
    # config['save_folder'] = '/media/swetha/b88e5742-94fe-4a6a-b859-5988abbd5e26/udan'
    # config['log_folder'] = '/media/swetha/b88e5742-94fe-4a6a-b859-5988abbd5e26/udan/logs'
    config['save_base_path'] = ''
    config['batch_size'] = 1
...
def init_train_mot17():
    config['epoch_size'] = 1329 #2658 # 1329 #664
    config['mot_root'] = '/home/c3-0/swetha/Datasets/MOT17'
    config['base_net_folder'] = None#'./weights/vgg16_reducedfc.pth'
    config['save_base_path'] = '/home/c3-0/swetha/runs/csm_sst/train_ss_sdp_b4_g2_run1/'
    config['log_folder'] = config['save_base_path']
    config['save_folder'] = config['save_base_path'] + 'weights'
    config['save_images_folder'] = config['save_base_path'] + 'images'
    config['type'] = 'train'
    config['write_file'] = True
    config['tensorboard'] = True
    config['save_combine'] = False
...
def init_eval_train_mot17():
    config['epoch_size'] = 2658  # 1329 #664
    config['mot_root'] = '/media/swetha/b88e5742-94fe-4a6a-b859-5988abbd5e26/Datasets/MOT17'
    config['base_net_folder'] = './weights/vgg16_reducedfc.pth'
    config['log_folder'] = '/media/swetha/b88e5742-94fe-4a6a-b859-5988abbd5e26/udan/csm_ss/sota_model/train_predictions'
    config['save_folder'] = '/media/swetha/b88e5742-94fe-4a6a-b859-5988abbd5e26/udan/logs/train_ss_v/weights'
    config['save_images_folder'] = '/media/swetha/b88e5742-94fe-4a6a-b859-5988abbd5e26/udan/logs/train_ss_v/images'
    config['type'] = 'train'
    config['write_file'] = True
    config['tensorboard'] = True
    config['save_combine'] = False
...
all_functions += [init_eval_train_mot17]
