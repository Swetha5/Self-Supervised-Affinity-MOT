...
parser.add_argument('--detection_root', default=r"D:\ssj\DETRAC\20170721Result\0803-E25-M80-G30-TestSet-EB-UA\EB",
                    help='the detection folder')
parser.add_argument('--ignore_root', default=r"F:\ssj\github\DETRAC-MOT-toolkit\evaluation\igrs",
                    help='the ignore folder')
parser.add_argument('--save_root', default=r"D:\ssj\DETRAC\20170721Result\0803-E25-M80-G30-TestSet-EB-UA\EB-new",
