...
parser.add_argument('--image1',
                    default="/media/jianliu/ssm/dataset/dataset/MOT/17/MOT17/train/MOT17-11-FRCNN/img1/000001.jpg",
                    help='Previous Image')
parser.add_argument('--image2',
                    default="/media/jianliu/ssm/dataset/dataset/MOT/17/MOT17/train/MOT17-11-FRCNN/img1/000030.jpg",
                    help='Current Image')
parser.add_argument('--model_path', default="/media/jianliu/ssm/ssj/github/weights/sst300_0712_66400.pth",
                    help='sst net model path')
...
class CompareTools:
    ...
    def run():
        ...
        while (1):
            ...
            CompareTools.img = cv2.resize(CompareTools.img,
                                          (int(CompareTools.resize_rate * w), int(CompareTools.resize_rate * h)))
