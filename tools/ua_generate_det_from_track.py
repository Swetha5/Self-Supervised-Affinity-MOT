...
parser.add_argument('--track_root',
                    default=r"F:\dataset\dataset\UA-DETRAC\other-methods-result\Tracker-joint-det-track-id\Tracker-joint-det-track-id\Detector-joint-det-track-id",
                    help='your track result root')

parser.add_argument('--save_root',
                    default=r"F:\dataset\dataset\UA-DETRAC\other-methods-result\Tracker-joint-det-track-id\Detection")
...
print("""Get sequences""")
sequences = np.unique(
    [seq[:9] for seq in os.listdir(os.path.join(args.track_root, thresholds[0])) if os.path.splitext(seq)[1] == ".txt"])
