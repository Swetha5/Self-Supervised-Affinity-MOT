...
parser = argparse.ArgumentParser(
    description='the tools for copy eb files to the specified folders according the sequences list')
parser.add_argument('--eb_root', default=r"D:\ssj\DETRAC\20170721Result\0803-E25-M80-G30-TestSet-EB-UA\EB-Test\EB",
                    help='the eb folder')
parser.add_argument('--eb_destination',
                    default=r"D:\ssj\DETRAC\20170721Result\0803-E25-M80-G30-TestSet-EB-UA\EB-Test\EBNew",
                    help='the destination folders')
...
eb_txt_name_list = [f for f in os.listdir(args.eb_root) if
                    os.path.isfile(os.path.join(args.eb_root, f)) and os.path.splitext(f)[1] == '.txt']
