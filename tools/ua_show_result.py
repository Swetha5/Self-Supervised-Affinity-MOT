...
parser.add_argument('--image_root', default=r"F:\dataset\dataset\UA-DETRAC\Insight-MVT_Annotation_Test",
                    help='the image folder')
parser.add_argument('--result_root',
                    default=r"F:\dataset\dataset\UA-DETRAC\other-methods-result\Tracker-joint-det-track-id\Tracker-joint-det-track-id\Detector-joint-det-track-id\0.0",
...
names = [os.path.splitext(os.path.basename(f))[0][:9] for f in os.listdir(args.result_root) if
         'speed' not in os.path.basename(f)]
