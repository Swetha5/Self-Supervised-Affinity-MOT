...
parser.add_argument('--detection_root',
                    default=r"D:\ssj\DETRAC\20170721Result\0812-E25-M80-G30-TestSet-EB-Upload\EB\EB",
                    help='your result folder to check')
parser.add_argument('--result_root', default=r"D:\ssj\DETRAC\20170721Result\0812-E25-M80-G30-TestSet-EB-Upload\SST",
                    help='the template root to check')
